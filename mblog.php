...
if(mysql_num_rows($res)>0){
	$c.='<div class="main_left">
			<div class="comm">
				<div class="vge_nav">
					<a href="'.($user_id>0?'user-'.$cuid.'.html':'#').'" class="current">微博</a>'.(($user_id>0 && $user_id!=$cuid)?'<a href="user_active.php?id='.$cuid.'">TA的活动</a><a href="user_decoration.php?id='.$cuid.'">TA的项目</a>':'').'
				</div>
				<div class="vge_inf">
