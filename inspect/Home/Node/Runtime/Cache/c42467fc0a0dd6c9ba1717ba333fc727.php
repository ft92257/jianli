...
<table>
	...
	<?php if(is_array($soft_fields)): foreach($soft_fields as $field=>$vo): ?><tr><td><?php echo ($vo[0]); ?></td><td>￥<?php echo ($soft_budget[$field]); ?></td><td><input type="text" name="<?php echo ($field); ?>" value="<?php echo ($soft_realfee[$field]); ?>" /></td></tr><?php endforeach; endif; ?>
</table>
