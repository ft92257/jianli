...
$(function(){
	...
	$("#tab_forecast").click(function(){
		_updatePie({"electric":$("#fee_electric").html(), "furniture":$("#fee_furniture").html(), "fabric":$("#fee_fabric").html(), "green":$("#fee_green").html(), "illumination":$("#fee_illumination").html(), "furnishing":$("#fee_furnishing").html()});
	});
	$("#tab_my").click(function(){
		_updatePie({"electric":$("#electric").val(), "furniture":$("#furniture").val(), "fabric":$("#fabric").val(), "green":$("#green").val(), "illumination":$("#illumination").val(), "furnishing":$("#furnishing").val()});
	});
	$("#tab_real").click(function(){
		_updatePie({"electric":$("#real_electric").html(), "furniture":$("#real_furniture").html(), "fabric":$("#real_fabric").html(), "green":$("#real_green").html(), "illumination":$("#real_illumination").html(), "furnishing":$("#real_furnishing").html()});
	});
});
