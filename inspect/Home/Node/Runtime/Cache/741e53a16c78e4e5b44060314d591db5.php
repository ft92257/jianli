...
<div class="w-31 pl-1-5 pr-1-5 pt-2 pb-2">
<form id="shutdownFrom" action="__GROUP__/Step/edit" method="post">
 <textarea rows="4" style="width:310px; resize:none" class="validate[required]" name="description"></textarea><br/><?php echo ($time); ?><br/>
 <input type="hidden" value="shutdown" name="act"/>
<input type="hidden" value="<?php echo ($no); ?>" name="no"/>
 <div class="clearfix mt-1-5"><input type="submit" class="right btn-s" value=""/></div>
 </form>
 </div>
